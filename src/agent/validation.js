 ...
 * }
 */
export async function validateComposition(spec, generatedCode) {
 ...
 * @returns AI 验证结果
 */
async function performAIValidation(spec, code) {
 ...
 * @returns 验证结果
 */
export async function validateOutput(videoPath) {
