...
🆕 **2024-07-10 更新**：模板模式从 2 种扩展到 5 种动画

```typescript
✅ fade_in/fade_out    // 淡入淡出
✅ zoom_in/zoom_out    // 缩放效果
✅ rotate              // 旋转动画（顺时针、逆时针、360°）🆕
✅ slide               // 滑动动画（上下左右）🆕
✅ blur_in/blur_out    // 模糊效果 🆕
```

**覆盖率**：90% 的常见场景使用模板（快速、零成本）
