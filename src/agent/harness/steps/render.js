...
export class RenderStep {
     ...
     */
    async execute(buildArtifact, timelineArtifact, outputPath) {
     ...
     * 准备 Remotion 入口文件
     */
    async prepareEntryPoint(buildArtifact, timelineArtifact, outputPath) {
     ...
     * 生成入口代码
     */
    generateEntryCode(buildArtifact, timelineArtifact) {
